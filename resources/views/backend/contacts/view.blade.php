<div class="row mt-4 mb-4">
    <div class="col">
            ...
            {{ html()->label(__('validation.attributes.backend.contacts.id'))->class('col-md-2 form-control-label')->for('id') }}
            <div class="col-md-10">
           ...
           {{ $contact->status? $contact->status->code : 'N/A' }}
            ...
            <div class="form-group row">
            {{ html()->label(__('validation.attributes.backend.contacts.phone'))->class('col-md-2 form-control-label')->for('phone') }}
            <div class="col-md-10">
